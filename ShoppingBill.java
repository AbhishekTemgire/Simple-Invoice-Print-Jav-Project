...
public class ShoppingBill {
	public static void main(String args[]) {
		...
		System.out.println("\t\t\t\t\t " + "  " + "SadGuru Smart Mall");
		System.out.println("\t\t\t\t\t3/98 Mecrobertganj New Pune");
		System.out.println("\t\t\t\t\t" + "  " +"Opposite Pune Metro Stop.");
		System.out.println("GSTIN: 03AWBPP8756K592" + "\t\t\t\t\t\t\tContact: (+91)8275725036");
